...
6. Treat a concept as missing when it has no explicit explanation, derivation, or worked example in the notebook; brief name-only mentions count as insufficient coverage and should be flagged.
